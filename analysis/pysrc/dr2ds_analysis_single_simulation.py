'''
File: dr2ds_analysis_single_simulation.py
...
dcontourdt_x, dcontourdt_y = npi.group_by(np.around(dt_z)).mean(dS_z)  # dt, dS
...
f.to_csv(join(output_foldername,
              "dr2ds_configuration_path_analysis.txt"), index=False, sep='\t', na_rep='nan')
